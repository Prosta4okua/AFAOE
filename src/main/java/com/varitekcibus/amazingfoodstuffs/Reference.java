...
public class Reference {
	...
	public static final String MODID = "afaoe";
	public static final String NAME = "Amazing FoodStuffs and Other Essentials";
	public static final String VERSION = "1.2.2.7";
